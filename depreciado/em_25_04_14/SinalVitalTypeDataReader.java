...
public final class SinalVitalTypeDataReader extends DataReader  {
  
  SinalVitalTypeDataReader (Subscriber             s,
                        TopicDescription       td,
                        SWIGTYPE_p__DataReader j_dr) {
     super(s,td,j_dr);
  }
  public ReturnCode_t    read( SinalVitalTypeSeq                   received_data,
    ...
    ReturnCode_t retval =  _read(tmp_seq, sample_infos, max_samples,
                                 ...
                                 SinalVitalType.class);
    received_data.value = (SinalVitalType[])tmp_seq.value;
    return retval;
  }
  public ReturnCode_t    read_w_condition( SinalVitalTypeSeq       received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
    ...
    ReturnCode_t retval =  _read_w_condition(tmp_seq, sample_infos, max_samples,
                                 condition, SinalVitalType.class);
    received_data.value = (SinalVitalType[])tmp_seq.value;
    return retval;
  }
  public ReturnCode_t    read_next_sample( SinalVitalType          received_data,
                                    SampleInfo  sample_info) {
    ReturnCode_t retval;
    SinalVitalTypeSeq tmp_seq = new SinalVitalTypeSeq();
  ...
  public ReturnCode_t    read_instance( SinalVitalTypeSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
  ...
  public ReturnCode_t    read_next_instance( SinalVitalTypeSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
  ...
  public ReturnCode_t    read_next_instance_w_condition( SinalVitalTypeSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 InstanceHandle_t        handle,
			 ReadCondition           condition) {
    ...
    ReturnCode_t retval =  _read_next_instance_w_condition(tmp_seq, sample_infos, max_samples,
                                 handle, condition, SinalVitalType.class);
    received_data.value = (SinalVitalType[])tmp_seq.value;
    return retval;
  }
  public ReturnCode_t    take( SinalVitalTypeSeq                   received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 long                    sample_states,
			 long                    view_states,
  ...
  public ReturnCode_t    take_w_condition( SinalVitalTypeSeq       received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 ReadCondition           condition) {
    sample_infos.value  = null;
  ...
  public ReturnCode_t    take_next_sample( SinalVitalType          received_data,
                                    SampleInfo  sample_info) {
    ReturnCode_t retval;
    SinalVitalTypeSeq tmp_seq = new SinalVitalTypeSeq();
    SampleInfoSeq si_seq = new SampleInfoSeq();
  ...
  public ReturnCode_t    take_instance( SinalVitalTypeSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 InstanceHandle_t        handle,
			 long                    sample_states,
  ...
  public ReturnCode_t    take_next_instance( SinalVitalTypeSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 InstanceHandle_t        prev_handle,
			 long                    sample_states,
  ...
  public ReturnCode_t    take_next_instance_w_condition( SinalVitalTypeSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 InstanceHandle_t        handle,
			 ReadCondition           condition) {
  ...
  public ReturnCode_t    return_loan( SinalVitalTypeSeq                   received_data,
                                      SampleInfoSeq           sample_infos) {
    ReturnCode_t retval =  _return_loan(null, sample_infos);
    return retval;
  }
  public ReturnCode_t     get_key_value(SinalVitalType                  key_holder,
                                        InstanceHandle_t    handle) {
    ReturnCode_t retval  = _get_key_value(key_holder, handle);
    return retval;
  }
  public InstanceHandle_t lookup_instance(SinalVitalType                  instance_data) {

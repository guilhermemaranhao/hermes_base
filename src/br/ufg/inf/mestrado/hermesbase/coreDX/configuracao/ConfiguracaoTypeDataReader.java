...
public final class ConfiguracaoTypeDataReader extends DataReader  {
  
  ConfiguracaoTypeDataReader (Subscriber             s,
                        TopicDescription       td,
                        SWIGTYPE_p__DataReader j_dr) {
     super(s,td,j_dr);
  }
  public ReturnCode_t    read( ConfiguracaoTypeSeq                   received_data,
    ...
    ReturnCode_t retval =  _read(tmp_seq, sample_infos, max_samples,
                                 ...
                                 ConfiguracaoType.class);
    received_data.value = (ConfiguracaoType[])tmp_seq.value;
    return retval;
  }
  public ReturnCode_t    read_w_condition( ConfiguracaoTypeSeq       received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
    ...
    ReturnCode_t retval =  _read_w_condition(tmp_seq, sample_infos, max_samples,
                                 condition, ConfiguracaoType.class);
    received_data.value = (ConfiguracaoType[])tmp_seq.value;
    return retval;
  }
  public ReturnCode_t    read_next_sample( ConfiguracaoType          received_data,
                                    SampleInfo  sample_info) {
    ReturnCode_t retval;
    ConfiguracaoTypeSeq tmp_seq = new ConfiguracaoTypeSeq();
  ...
  public ReturnCode_t    read_instance( ConfiguracaoTypeSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
  ...
  public ReturnCode_t    read_next_instance( ConfiguracaoTypeSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
  ...
  public ReturnCode_t    read_next_instance_w_condition( ConfiguracaoTypeSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 InstanceHandle_t        handle,
			 ReadCondition           condition) {
    ...
    ReturnCode_t retval =  _read_next_instance_w_condition(tmp_seq, sample_infos, max_samples,
                                 handle, condition, ConfiguracaoType.class);
    received_data.value = (ConfiguracaoType[])tmp_seq.value;
    return retval;
  }
  public ReturnCode_t    take( ConfiguracaoTypeSeq                   received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 long                    sample_states,
			 long                    view_states,
  ...
  public ReturnCode_t    take_w_condition( ConfiguracaoTypeSeq       received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 ReadCondition           condition) {
    sample_infos.value  = null;
  ...
  public ReturnCode_t    take_next_sample( ConfiguracaoType          received_data,
                                    SampleInfo  sample_info) {
    ReturnCode_t retval;
    ConfiguracaoTypeSeq tmp_seq = new ConfiguracaoTypeSeq();
    SampleInfoSeq si_seq = new SampleInfoSeq();
  ...
  public ReturnCode_t    take_instance( ConfiguracaoTypeSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 InstanceHandle_t        handle,
			 long                    sample_states,
  ...
  public ReturnCode_t    take_next_instance( ConfiguracaoTypeSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 InstanceHandle_t        prev_handle,
			 long                    sample_states,
  ...
  public ReturnCode_t    take_next_instance_w_condition( ConfiguracaoTypeSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 InstanceHandle_t        handle,
			 ReadCondition           condition) {
  ...
  public ReturnCode_t    return_loan( ConfiguracaoTypeSeq                   received_data,
                                      SampleInfoSeq           sample_infos) {
    ReturnCode_t retval =  _return_loan(null, sample_infos);
    return retval;
  }
  public ReturnCode_t     get_key_value(ConfiguracaoType                  key_holder,
                                        InstanceHandle_t    handle) {
    ReturnCode_t retval  = _get_key_value(key_holder, handle);
    return retval;
  }
  public InstanceHandle_t lookup_instance(ConfiguracaoType                  instance_data) {
